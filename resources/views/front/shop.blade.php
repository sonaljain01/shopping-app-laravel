                                ...
                                <div class="product_grid card b-0">
                                    ...
                                    <div class="row align-items-center rows-products">
                                        <div class="d-flex align-items-start justify-content-between">
                                            <div class="text-left">
                                                <!-- Product Color Options (If you want to display color options) -->
                                                <div class="form-check form-option form-check-inline mb-1">
                                                    <input class="form-check-input" type="radio"
                                                        name="color{{ $product->id }}" id="white{{ $product->id }}">
                                                    <label class="form-option-label small rounded-circle"
                                                        for="white{{ $product->id }}">
                                                        <span class="form-option-color rounded-circle blc5"></span>
                                                    </label>
                                                </div>
                                                <div class="form-check form-option form-check-inline mb-1">
                                                    <input class="form-check-input" type="radio"
                                                        name="color{{ $product->id }}" id="blue{{ $product->id }}">
                                                    <label class="form-option-label small rounded-circle"
                                                        for="blue{{ $product->id }}">
                                                        <span class="form-option-color rounded-circle blc2"></span>
                                                    </label>
                                                </div>
                                                <div class="form-check form-option form-check-inline mb-1">
                                                    <input class="form-check-input" type="radio"
                                                        name="color{{ $product->id }}" id="yellow{{ $product->id }}">
                                                    <label class="form-option-label small rounded-circle"
                                                        for="yellow{{ $product->id }}">
                                                        <span class="form-option-color rounded-circle blc6"></span>
                                                    </label>
                                                </div>
                                                <div class="form-check form-option form-check-inline mb-1">
                                                    <input class="form-check-input" type="radio"
                                                        name="color{{ $product->id }}" id="pink{{ $product->id }}">
                                                    <label class="form-option-label small rounded-circle"
                                                        for="pink{{ $product->id }}">
                                                        <span class="form-option-color rounded-circle blc4"></span>
                                                    </label>
                                                </div>
                                            </div>
